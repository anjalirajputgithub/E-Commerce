    ...
    const handleImageUpload = async (e) => {
        ...
        try {
            ...
            setProductData((prevData) => ({
                ...prevData,
                images: [...prevData.images, {url: data.iamgeUrl, altText: ""}],
            }));
            setUploading(false);
        } catch (error) {
            console.error(error);
    ...
    <div className='max-w-5xl mx-auto p-6 shadow-md rounded-md'>
        ...
        <form onSubmit={handleSubmit}>
            <div className='mb-6'>
                ...
                onChange={handleChange} className='w-full  border border-gray-300 rounded-md p-2' required/>
            </div>
            ...
            <div className='mb-6'>
                ...
                onChange={handleChange} className='w-full border-gray-300 rounded-md p-2' row={4} required />
            </div>
            ...
            <button type='submit' className='w-full bg-green-600 text-white py-2 rounded-md hover:bg-green-500 transition-colors'>
                Update Product
            </button>
        </form>      
    </div>
